...
- Cross-Contextual Logic, the author explains _why_ a change was made in a way that shows understanding of the project's specific constraints, rather than just repeating the issue text.
