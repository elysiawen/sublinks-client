...
pub static APP_ID: &str = "sublinks";
#[cfg(not(feature = "verge-dev"))]
pub static BACKUP_DIR: &str = "sublinks-backup";

#[cfg(feature = "verge-dev")]
pub static APP_ID: &str = "sublinks.dev";
#[cfg(feature = "verge-dev")]
pub static BACKUP_DIR: &str = "sublinks-backup-dev";
