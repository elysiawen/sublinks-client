...
export const translationKeys = [
  ...
  "home.page.tooltips.updateAvailable",
  "home.page.tooltips.updateNow",
  "home.page.tooltips.skipVersion",
  ...
  "home.components.welcomeBanner.greetings.earlyMorning",
  "home.components.welcomeBanner.greetings.morning",
  "home.components.welcomeBanner.greetings.forenoon",
  "home.components.welcomeBanner.greetings.noon",
  "home.components.welcomeBanner.greetings.afternoon",
  "home.components.welcomeBanner.greetings.evening",
  "home.components.welcomeBanner.greetings.night",
  "home.components.welcomeBanner.greetings.lateNight",
  "home.components.welcomeBanner.hitokoto.loading",
  "home.components.welcomeBanner.hitokoto.fallback",
  "home.components.welcomeBanner.tooltips.refreshBackground",
  "home.components.mini.realtimeUpload",
  "home.components.mini.realtimeDownload",
  "home.components.mini.alwaysOnTop",
  "home.components.mini.autoHideFullscreen",
  "home.components.mini.closeMiniWindow",
  ...
  "layout.components.navigation.tabs.test_web",
  "layout.components.navigation.tabs.test_media",
  ...
  "layout.components.navigation.tabs.about",
  "layout.components.navigation.aboutPage.attribution",
  ...
  "layout.components.navigation.userInfo.loggedIn",
  "layout.components.navigation.userInfo.logout",
  "layout.components.navigation.userInfo.logoutConfirmationTitle",
  "layout.components.navigation.userInfo.logoutConfirmationMessage",
  "layout.components.navigation.userInfo.loggingOut",
  "layout.components.navigation.userInfo.amountLogout",
  "layout.components.navigation.userInfo.cancel",
  "layout.api.messages.usernameAndPasswordRequired",
  "layout.api.messages.invalidCredentials",
  "layout.api.messages.accountDisabled",
  "layout.api.messages.serverError",
  "layout.api.messages.sessionExpired",
  "layout.notifications.autoSyncSuccess",
  "layout.notifications.autoSyncFailed",
  "layout.notifications.loginSuccess",
  "layout.notifications.logoutSuccess",
  "layout.notifications.logoutFailed",
  "layout.notifications.syncFetchingSubs",
  "layout.notifications.syncProcessingSub",
  "layout.notifications.syncActivating",
  "layout.notifications.syncComplete",
  "layout.notifications.syncNoChanges",
  "layout.notifications.syncResult",
  "layout.notifications.syncNewCount",
  "layout.notifications.syncUpdatedCount",
  "layout.notifications.syncDeletedCount",
  "layout.notifications.syncNetworkError",
  "layout.notifications.loggedOutLocal",
  "layout.notifications.loginRequestFailed",
  "layout.notifications.loginNoToken",
  "layout.notifications.loggingIn",
  "layout.notifications.serverInvalidResponse",
  "layout.notifications.syncVerifying",
  "layout.notifications.cannotConnectServer",
  "layout.notifications.loginTitle",
  "layout.notifications.username",
  "layout.notifications.password",
  "layout.notifications.totpCode",
  "layout.notifications.backToChangePassword",
  "layout.notifications.verify",
  "layout.notifications.login",
  "layout.notifications.browserLogin",
  "layout.notifications.passwordLogin",
  "layout.notifications.deviceAuthTitle",
  "layout.notifications.deviceAuthDesc",
  "layout.notifications.deviceAuthOpenBrowser",
  "layout.notifications.deviceAuthWaiting",
  "layout.notifications.deviceAuthExpired",
  "layout.notifications.deviceAuthSuccess",
  "layout.notifications.deviceAuthManualCopy",
  "layout.notifications.deviceAuthCopyLink",
  "layout.notifications.deviceAuthDenied",
  "layout.notifications.deviceAuthTooMany",
  "logs.page.title",
  ...
  "profiles.page.actions.syncSubscriptions",
  ...
  "settings.sections.sublinks.title",
  "settings.sections.sublinks.fields.autoSync",
  "settings.sections.sublinks.descriptions.autoSync",
  ...
  "settings.components.sidebar.title",
  "settings.components.sidebar.essential",
  ...
  "settings.components.verge.basic.fields.miniWindow",
  ...
  "settings.components.verge.advanced.notifications.checking",
  "settings.components.verge.advanced.notifications.newVersion",
  "settings.components.verge.advanced.notifications.failed",
  "settings.components.verge.advanced.notifications.refreshTokenFailed",
  "settings.components.verge.advanced.notifications.fetchUserInfoFailed",
  ...
  "settings.components.verge.updateDialog.title",
  "settings.components.verge.updateDialog.releaseTime",
  "settings.components.verge.updateDialog.download",
  "settings.components.verge.updateDialog.cancel",
